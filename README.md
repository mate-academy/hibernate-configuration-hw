...
__!!! Important:__ you should have only `Movie` model with mate.academy.dao and mate.academy.service layer. Don't create other models and don't push them to PR.
