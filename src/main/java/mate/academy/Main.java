...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        homeAlone1.setDescription("An eight-year-old troublemaker must protect  "
        ...
        homeAlone2.setDescription("One year after Kevin McCallister was left home alone and "
                + "had to defeat a pair of bumbling burglars, he accidentally finds himself "
                + "stranded in New York City - and the same criminals are not far behind.");
